...
export default function AdminOrdersPage() {
    ...
    // Debug log
    console.log(
        "AdminOrdersPage render - showModal:",
        showModal,
        "selectedOrder:",
        selectedOrder
    );
        ...
        <div>
                            ...
                            <tr key={order.id} className="hover:bg-gray-50">
                                ...
                                <td className="px-6 py-4">
                                    <select
                                        ...
                                        className={`inline-flex items-center gap-1 px-3 py-2 rounded-full text-xs font-medium border-0 cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-1 ${getStatusColor(
                                            order.status
                                        )}`}
                                        style={{
                                            appearance: "none",
            ...
            {showModal && (
                <div className="fixed top-4 right-4 bg-blue-500 text-white p-2 rounded z-[10000]">
                    Modal State: {showModal ? "true" : "false"}, Order:{" "}
