...
const blogPosts = [
    {
        ...
        excerpt:
            "Khám phá những xu hướng công nghệ đang định hình tương lai và cách chúng ảnh hưởng đến cuộc sống hàng ngày.",
        content:
            "Năm 2024 đánh dấu một bước ngoặt quan trọng trong sự phát triển của công nghệ...",
        author: "Nguyễn Tech",
        date: "2024-11-15",
        category: "Công nghệ",
    ...
    },
    {
        ...
        excerpt:
            "Hướng dẫn chi tiết giúp bạn lựa chọn chiếc laptop hoàn hảo cho việc học tập và làm việc.",
    ...
    },
    {
        ...
        excerpt:
            "Đánh giá toàn diện về chiếc flagship mới nhất của Apple với những cải tiến đáng chú ý.",
    ...
    },
    {
        ...
        excerpt:
            "Danh sách những phụ kiện gaming giúp nâng cao trải nghiệm chơi game của bạn.",
    ...
    },
    {
        ...
        excerpt:
            "Những biện pháp bảo vệ thông tin cá nhân hiệu quả trên smartphone và tablet.",
...
export default function BlogPage() {
    ...
    const regularPosts = filteredPosts.filter(
        (post) => !post.featured || selectedCategory !== "Tất cả" || searchTerm
    );
        ...
        <div className="min-h-screen bg-gray-50">
            <div className="container mx-auto px-4 sm:px-8 md:px-16 lg:px-40 py-6 md:py-10">
                ...
                <div className="text-center mb-8 md:mb-10">
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-3 md:mb-4">
                        Blog Cyber Store
                    </h1>
                    <p className="text-sm md:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto px-4">
                        Khám phá những xu hướng công nghệ mới nhất, hướng dẫn sử
                        dụng sản phẩm và những bài review chi tiết từ đội ngũ
